...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//FILESYSTEM CONFIG
		...
		*/
	# Added by Samiul Amin 28 Nov, 2010
	$path = '';
	if(isset($_GET['path']) && $_GET['path'] != '' || isset($_GET['folder']) && $_GET['folder'] != ''){
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../assets/agent_assets/'.$path.'/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../assets/agent_assets/'.$path.'/');	//accept relative path only

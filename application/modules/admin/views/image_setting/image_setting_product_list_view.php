...
<!--  start step-holder -->
     <div id="step-holder">
        ...
        <div class="step-dark-left"><a href="<?php echo site_url('settings/image_setting/image_setting_product_list')?>"><?php echo $this->lang->line('image_setting_product_list'); ?></a></div>
...
<tbody>
<?php
$query=$this->db->where('image_setting_type',1)->get('settings_image_size');

...
<!--  start step-holder -->
        ...
        <div class="step-dark-left"><a href="<?php echo site_url('settings/image_setting/image_setting_single_service')?>"><?php echo $this->lang->line('image_setting_single_service'); ?></a></div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
               <select id="settings_image_size_id" name="settings_image_size_id" style="width:350px;" >
                   ...
                   $this->db->where(array('image_size_type'=>2,'image_setting_type'=>2));
...
<tbody>
<?php
$query=$this->db->where(array('image_setting_type'=>2,'image_size_type'=>2))->get('settings_image_size');

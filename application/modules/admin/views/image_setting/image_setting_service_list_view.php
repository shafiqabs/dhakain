...
<form class="form-horizontal" name="delete_list" id="delete_list" action="<?php echo site_url('settings/image_setting/image_setting_product_delete/'.$this->uri->segment(4,0))?>" method="post">
...
<!--  start step-holder -->
       <div id="step-holder">
        ...
        <div class="step-dark-left"><a href="<?php echo site_url('settings/image_setting/image_setting_service_list')?>"><?php echo $this->lang->line('image_setting_service_list'); ?></a></div>
...
<th><?php echo $this->lang->line('image_setting_type'); ?></th>
...
<tbody>
<?php
$query=$this->db->where(array('image_setting_type'=>2))->get('settings_image_size');
...
<td><?php if($rows->image_size_type == 1){ echo $this->lang->line('image_setting_multiple_size'); }else{ echo $this->lang->line('image_setting_single_size'); } ?></td>
...
<td>
<a class="edit_img" href="<?php echo site_url('settings/image_setting/image_setting_product_edit/'.$rows->settings_image_size_id)?>"></a>
...
$(document).ready(function(){
	...
	$(".delete_img").click(function(){	
        ...
        jConfirm(jconfirm,confirm_title,function(r) {
            if(r){
              window.location.href='<?php echo site_url('settings/image_setting/image_setting_product_delete');?>/'+id;
            }
        });
	})

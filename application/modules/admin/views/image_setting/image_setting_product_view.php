...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url('settings/image_setting/image_setting_product_add')?>" method="post">
...
<!--  start step-holder -->
    ...
    <div id="step-holder">
        ...
        <div class="step-dark-left"><a href="<?php echo site_url('settings/image_setting/image_setting_product')?>"><?php echo $this->lang->line('image_setting_category'); ?></a></div>
...
<!--  end step-holder -->
            ...
            <div class="list_title">
                ...
                <div class="input_line">
                    ...
                    <?php
                        ...
                        $this->db->where(array('image_setting_type'=>1,'image_size_type'=>1));
            ...
            <div id="loader">
                <?php
                $query=$this->image_setting_product_model->categorylist();
                foreach ( $query->result() as $rows ){
                    $category_id=$this->image_setting_product_model->get_image_size_category($settings_image_size_id,$rows->category_id);
                    ?>
                    ...
                    <div class="parent_radio_text">
                        ...
                        <div class="clear"></div>
                        <?php
                        $query=$this->image_setting_product_model->categorylist($rows->category_id);
                        foreach ( $query->result() as $rows ){
                            $category_id=$this->image_setting_product_model->get_image_size_category($settings_image_size_id,$rows->category_id);
...
<script type="text/javascript">
    $(document).ready(function(){
		...
		return false;
		  ...
		  $.ajax({
				type: "POST",
				url:"<?php echo site_url('settings/image_setting/image_setting_filter_product')?>",
				data:'id='+templateid,
				cache: false,

...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url('settings/image_setting/image_setting_service_insert')?>" method="post">
...
<!--  start step-holder -->
        ...
        <div class="step-light-left"><a href="<?php echo site_url('settings/image_setting/image_setting_service')?>"><?php echo $this->lang->line('image_setting_service_category'); ?></a></div>
        ...
        <div class="step-dark-left"><a href="<?php echo site_url('settings/image_setting/image_setting_service_manage')?>"><?php echo $this->lang->line('image_setting_service'); ?></a></div>
...
<div class="content-inner-box">
    ...
    <div class="control-group">
      ...
      <div class="control-group">
            <label for="input01" class="control-label"><?php echo $this->lang->line('square_image_width'); ?></label>
            <div class="controls">
              <input type="text" placeholder="Type <?php echo $this->lang->line('square_image_width'); ?>" class="validate[required] input-xlarge span3" name="square_image_width" id="square_image_width" value="<?php echo(isset($queryup[0]->square_image_width))? $queryup[0]->square_image_width : set_value('square_image_width'); ?>" >
            </div>
      </div>
      <div class="control-group">
            <label for="input01" class="control-label"><?php echo $this->lang->line('square_image_height'); ?></label>
            <div class="controls">
              <input type="text" placeholder="Type <?php echo $this->lang->line('square_image_height'); ?>" class="validate[required] input-xlarge span3" name="square_image_height" id="square_image_height" value="<?php echo(isset($queryup[0]->square_image_height))? $queryup[0]->square_image_height : set_value('square_image_height'); ?>" >
            </div>
      </div>
         <div class="control-group">

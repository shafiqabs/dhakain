...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url('settings/service_template/service_template_add')?>" method="post">
...
<!--  start step-holder -->
     <div id="step-holder">
        ...
        <div class="step-light-left"><a href="<?php echo site_url('settings/service_template/service_single_template')?>"><?php echo $this->lang->line('service_single_template'); ?></a></div>
        <div class="step-light-right">&nbsp;</div>
        <div class="step-no">3</div>
        <div class="step-dark-left"><a href="<?php echo site_url('settings/service_template/service_template_manage')?>"><?php echo $this->lang->line('service_template_manage'); ?></a></div>

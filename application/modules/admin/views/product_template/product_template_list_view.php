...
<td>
<a class="edit_img" href="<?php echo site_url('settings/product_template/product_template_edit/'.$rows->product_template_manage_id)?>"></a>
...
$(document).ready(function(){
	...
	$(".delete_img").click(function(){	
        ...
        jConfirm(jconfirm,confirm_title,function(r) {
            if(r){
              window.location.href='<?php echo site_url('settings/product_template/product_template_delete');?>/'+id;
            }
        });
	})

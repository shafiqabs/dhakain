...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url('settings/product_template/product_single_template_add')?>" method="post">
...
<!--  start step-holder -->
     <div id="step-holder">
        ...
        <div class="step-dark-left"><a href="<?php echo site_url('settings/product_template/product_single_template')?>"><?php echo $this->lang->line('product_single_template'); ?></a></div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
               <select id="product_template_manage_id" name="product_template_manage_id" style="width:350px;" >
                   ...
                   $this->db->where('product_template_type',2);
                   $shop=$this->db->get('product_template_manage');
                        $query=$shop->result();
...
<tbody>
<?php
$query=$this->db->where(array('product_template_type'=>2))->get('product_template_manage');
...
<td>
<a class="edit_img" href="<?php echo site_url('settings/product_template/product_single_template_edit/'.$rows->product_template_manage_id)?>"></a>
<a class="view_img" title="Template content view" href="<?php echo site_url('settings/product_template/product_template_view/'.$rows->product_template_manage_id)?>"></a>
...
$(document).ready(function(){
	...
	$(".delete_img").click(function(){
        ...
        jConfirm(jconfirm,confirm_title,function(r) {
            if(r){
              window.location.href='<?php echo site_url('settings/product_template/product_single_template_delete');?>/'+id;
            }
        });
	})

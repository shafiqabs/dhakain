...
<div class="clear"></div>
     ...
     <div style="float: left; width:645px; line-height: 25px; font-weight: bold;">Template name: <?php echo $managequery[0]->product_template_name; ?></div><a href="javascript:void(0)" class="btn btn-small btn-primary newrows">Add aditional field</a>
     </div>
     <div class="clear"></div>

...
<ul id="breadcrumbs"> <li><div id="home"><?php echo $this->lang->line('home'); ?></div><a href="<?php echo site_url();?>" id="first-bread"><?php echo $this->lang->line('home'); ?></a></li><li><?php echo $this->lang->line('service_category'); ?></li> 
</ul>
...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url('settings/service_category/service_category_add')?>" method="post">    
...
<!--  start step-holder -->
			...
			<div class="step-dark-left"><a href="<?php echo site_url('settings/service_category')?>"><?php echo $this->lang->line('service_category'); ?></a></div>
			...
			<div class="step-no-off">2</div>
            <div class="step-light-left"><a href="<?php echo site_url('settings/service_category/service_category_sorting')?>"><?php echo $this->lang->line('service_category_ordering'); ?></a></div>
...
<div class="content-inner-box">
       ...
       <div class="control-group">
            <label for="input01" class="control-label"><?php echo $this->lang->line('service_category_name'); ?></label>
            <div class="controls">
              <input type="text" placeholder="Type <?php echo $this->lang->line('service_category_name'); ?>" class="validate[required]" name="category_name" id="category_name" value="<?php echo(isset($queryup[0]->category_name))? $queryup[0]->category_name : set_value('category_name'); ?>" >
              <p class="help-block"><?php echo $this->lang->line('service_category_name_help'); ?></p>
            </div>
          </div>
          <div class="control-group">

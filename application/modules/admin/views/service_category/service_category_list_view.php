...
<form class="form-horizontal" name="delete_list" id="delete_list" action="<?php echo site_url('settings/service_category/service_category_delete/'.$this->uri->segment(4,0))?>" method="post">
...
<!--  start step-holder -->
            ...
            <div class="step-dark-left"><a href="<?php echo site_url('settings/service_category/service_category_list/0')?>"><?php echo $this->lang->line('service_category_list'); ?></a></div>
            <div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">3</div>
            <div class="step-light-left"><a href="<?php echo site_url('settings/service_category/service_category_ordering')?>"><?php echo $this->lang->line('service_category_ordering'); ?></a></div>
...
<div class="demo_jui">
<?php 
$arr=$this->paging_model->service_category_paging($per_page = 20,$num_link =3);	
$query=($arr[0]);
$paging=($arr[1]);
?>
...
<th><?php echo $this->lang->line('service_category_name'); ?></th>
...
?>
		<tr class="gradeX">
			...
			<td><?php echo $this->service_category_model->category_parent($rows->parent_id);  ?></td>
			...
			<td class="center">
            <a class="edit_img" href="<?php echo site_url('settings/service_category/service_category_edit')?>/<?php echo $rows->category_id ?>"></a>
			<a rel="<?php echo site_url('settings/service_category/service_category_delete/'.$this->uri->segment(4,0)); ?>/<?php echo $rows->category_id ?>" class="delete_img" href="javascript:void(0)"></a>

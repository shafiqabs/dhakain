...
class product_template_model extends CI_Model
{
    ...
    function template_insert()
	{
        ...
        $array=array('product_template_name'=>$product_template_name,'product_template_type'=>$product_template_type,'product_template_layout'=>$product_template_layout,'status' => $status);
        $this->db->set($array);
    ...
    function product_single_insert()
    {
        $product_template_manage_id=$this->input->post('product_template_manage_id');
    ...
    function product_template_multidelete()
    {
    ...
    function product_single_template_multidelete()
    {
        $array=$this->input->post('list');
        foreach( $array as $val ){
    ...
    function product_template_value()
    {

...
class Image_setting_service_model extends CI_Model
{
    ...
    function image_setting_service_insert()
	{
		...
		$square_image_width=$this->input->post('square_image_width');
		$square_image_height=$this->input->post('square_image_height');
        ...
        $array=array('image_setting_type'=>2,'image_size_type'=>$image_size_type,'settings_image_name' =>trim($settings_image_name),'large_image_width' =>trim($large_image_width),'large_image_height' =>trim($large_image_height),'square_image_width' =>trim($square_image_width),'square_image_height' =>trim($square_image_height),'thumb_image_width' =>trim($thumb_image_width),'thumb_image_height' =>trim($thumb_image_height),'small_image_width' =>trim($small_image_width),'small_image_height' =>trim($small_image_height),'status' =>$status);
        $this->db->set($array);
	...
	function image_setting_service_update(){
    ...
    function image_setting_single_service_insert()
    {
        $settings_image_size_id=$this->input->post('settings_image_size_id');
    ...
    function image_setting_single_service_multidelete()
    {
    ...
    function image_setting_service_multidelete()
    {
        $array=$this->input->post('list');
        foreach( $array as $val ){
            $this->db->set(array('category_id'=>''));

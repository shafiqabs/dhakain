        ...
        <div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="grid-table">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php if($rows->status ==1){ ?><a class="publish_img" href="<?php echo site_url($this->uri->segment(1,0).'/banner/status/'.$access_slug); ?>/<?php echo $rows->banner_id; ?>"></a><?php } else if($rows->status ==0){ ?><a class="unpublish_img" rel="" id="" href="<?php echo site_url($this->uri->segment(1,0).'/banner/status/'.$access_slug); ?>/<?php echo $rows->banner_id; ?>"></a><?php } ?></td>
                    <td class="center">
                        <a rel="<?php echo site_url($this->uri->segment(1,0).'/banner/delete/'.$access_slug); ?>/<?php echo $rows->banner_id; ?>" class="delete_img" href="javascript:void(0)"></a>
                    </td>
                </tr>

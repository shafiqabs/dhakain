...
<div id="loader">
    <?php
    $query=$this->classified_model->categorylist($storeInfo[0]->shop_group,$category_id=0);
                ...
                <?php
				$query1=$this->classified_model->categorylist($storeInfo[0]->shop_group,$rows->category_id);

...
<?php $this->load->view('admin/layouts/left_menu'); ?>
  ...
  <form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url($this->uri->segment(1,0).'/sponsor/delete/'.$access_slug )?>" method="post" enctype="multipart/form-data">
            ...
            <tr class="gradeX " id="listItem_<?php echo $rows->random_id; ?>">
              ...
              <td><?php echo $rows->settings_name; ?></td>
               <td class="center">
                  ...
                  <?php if($rows->status ==1){ ?><a class="publish_img" href="<?php echo site_url($this->uri->segment(1,0).'/sponsor/status/'.$access_slug.'/'.$rows->random_id); ?>"></a><?php } else if($rows->status ==0){ ?><a class="unpublish_img" rel="" id="" href="<?php echo site_url($this->uri->segment(1,0).'/sponsor/status/'.$access_slug.'/'.$rows->random_id); ?>"></a><?php } ?>
                  <a href="<?php echo site_url($this->uri->segment(1,0).'/sponsor/edit/'.$access_slug.'/'.$rows->random_id); ?>" class="edit_img" ></a>
                  <a rel="<?php echo site_url($this->uri->segment(1,0).'/sponsor/delete/'.$access_slug.'/'.$rows->random_id); ?>" class="delete_img" href="javascript:void(0)"></a>
              </td>
            </tr>

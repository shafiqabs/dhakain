...
<div class="left-area">
  ...
  <form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url($this->uri->segment(1,0).'/sponsor/save/'.$access_slug)?>" method="post" enctype="multipart/form-data">
      ...
      <fieldset class="sheet">
        ...
        <div class="control-group">
            ...
            <div class="controls">
              <input type="file" id="sponsor_image" class="input-file" name="sponsor_image">
        ...
        <div class="control-group">
          ...
          <div class="controls">
          <textarea name="alternative_sponsor" id="alternative_sponsor" rows="" cols="" class="input-textarea-large"><?php echo isset($queryup[0]->alternative_sponsor) ? $queryup[0]->alternative_sponsor : set_value('alternative_sponsor'); ?></textarea>
          </div>
        </div>
          <div class="control-group">
              <label  class="control-label"><?php echo $this->lang->line('sponsor_url'); ?></label>
              <div class="controls">
                  <input type="text" placeholder="Type <?php echo $this->lang->line('sponsor_url'); ?>" class="validate[required] input-medium  span6" name="sponsor_url" id="sponsor_url" value="<?php echo(isset($queryup[0]->sponsor_url))? $queryup[0]->sponsor_url : set_value('sponsor_url'); ?>" >
                  <p><?php echo $this->lang->line('sponsor_url_help'); ?></p>
              </div>
          </div>
        <div class="control-group">

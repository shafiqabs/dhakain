...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url('shoppingmall/mall/save/'.$access_slug)?>" method="post">
...
<div class="content-inner-box">
    ...
    <div class="control-group" >
        ...
        <div class="controls" style="margin-left: 122px;">
            <input type="text" placeholder="Type <?php echo $this->lang->line('mall_name'); ?>" class="validate[required] input-large  span6 shop_change" name="shop_name" id="shop_name" value="<?php echo(isset($queryup[0]->shop_name))? $queryup[0]->shop_name:set_value('shop_name'); ?>" ><span class="small_loading"></span>
        </div>
    </div>
    <div class="form-box">

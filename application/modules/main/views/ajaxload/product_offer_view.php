        ...
        <span>
            <dl>
                ...
                <dd onclick="window.location='<?php echo site_url('cart/'.$offers->product_slug); ?>" >Add to cart</dd>
                                ...
                                <img class="feature-lazy" alt="<?php echo $offers->product_name; ?>"  src="<?php echo base_url().'/'.$offers->image_small_path ?>"  >
                            </a>
                        </div>
                        <div class="link22">
        ...
        <span>
            <dl>
                ...
                <dd onclick="window.location='<?php echo site_url('cart/'.$offers->product_slug); ?>" >Add to cart</dd>
                                ...
                                <img alt="<?php echo $offers->product_name; ?>" class="feature-lazy" src="<?php echo base_url().'/'.$offers->image_small_path ?>"></a>
                        </div>
                        <div class="link22">
                            <a title="<?php echo $offers->product_name; ?>" href="<?php echo site_url('/details/'.$offers->category_slug.'/'.$offers->product_slug); ?>"></a>
                        </div>

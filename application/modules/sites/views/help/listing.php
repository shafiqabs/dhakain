...
<ul id="breadcrumbs">
    ...
    <li id="breadcrumb-right"><button class="btn  btn-info" onclick="window.location='<?php echo site_url('sites/help/create')?>'" ><i class="icon-edit icon-white"></i><?php echo $this->lang->line('add_help'); ?></button></li>
</ul>
            ...
            <td  valign="top" id="bnc">
                ...
                <div id="wptouch-tabbed-area" class="round-6 box-shadow persist-area" ><!-- Start box -->
                    <div class="content-box">
                        ...
                        <form class="form-horizontal" name="delete_list" id="delete_list" action="<?php echo site_url($this->uri->segment(1,0).'/help/delete/')?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="grid-table">
                                            ...
                                            foreach ($query as $rows ){
                                                ...
                                                <tr class="gradeX " id="listItem_<?php echo $rows->random_id; ?>">
                                                    ...
                                                    <td><?php echo customDateFormat($rows->created); ?></td>
                                                    <td><?php echo $rows->title; ?></td>

                                                    <td class="center">
                                                        <img src="<?php echo base_url();?>assets/images/arrow.png" alt="move" width="16" height="16" class="handle" />
                                                        <?php if($rows->status ==1){ ?><a class="publish_img" href="<?php echo site_url($this->uri->segment(1,0).'/help/status/'.$rows->random_id); ?>"></a><?php } else if($rows->status ==0){ ?><a class="unpublish_img" rel="" id="" href="<?php echo site_url($this->uri->segment(1,0).'/help/status/'.$rows->random_id); ?>"></a><?php } ?>
                                                        <a href="<?php echo site_url($this->uri->segment(1,0).'/help/edit/'.$rows->random_id); ?>" class="edit_img" ></a>
                                                        <a rel="<?php echo site_url($this->uri->segment(1,0).'/help/delete/'.$rows->random_id); ?>" class="delete_img" href="javascript:void(0)"></a>
                                                    </td>
                                                </tr>
    ...
    $(document).ready(function() {
        $(".sorting").sortable({
            ...
            update : function () {
                ...
                $.ajax({
                    type: "POST",
                    url:"<?php echo site_url('sites/help/ordering')?>",
                    data:order,
                    cache: false,

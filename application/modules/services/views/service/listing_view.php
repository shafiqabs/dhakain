...
<ul id="breadcrumbs">
  ...
  <li><a href="<?php echo site_url($this->uri->segment(1,NULL));?>" ><?php echo $this->lang->line('service_list'); ?></a></li>
    <li id="breadcrumb-right"><button class="btn  btn-info" id="addStore" data-toggle="modalx" href="#serviceModal" ><i class="icon-edit icon-white"></i><?php echo $this->lang->line('add_service'); ?></button></li>
</ul>
...
<?php $this->load->view('services/service/add_service'); ?>

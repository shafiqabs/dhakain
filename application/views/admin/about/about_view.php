...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url($this->uri->segment(1,'none').'/about/save/'.$access_slug)?>" method="post">
...
<div class="clear"></div>
     <div class="content-inner-box">
         <div class="control-group" >
             <label  class="control-label control-label-textarea"><?php echo $this->lang->line('about'); ?></label>
         </div>
         <div class="control-group" >
             <textarea name="about" id="about" class="input-textarea-large" rows="" cols=""><?php echo(isset($queryup[0]->about))? $queryup[0]->about : set_value('about'); ?></textarea>
         </div>
     </div>

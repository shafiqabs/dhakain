...
<form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url($this->uri->segment(1,'none').'/banner/save/'.$access_slug)?>" method="post" enctype="multipart/form-data">
<div class="right-area ">
        ...
        <div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="grid-table">
                ...
                <tr class="gradeX">
                    ...
                    <td><?php if($rows->status ==1){ ?><a class="publish_img" href="<?php echo site_url($this->uri->segment(1,0).'/'.$this->uri->segment(2,0).'/status_banner/'.$access_slug); ?>/<?php echo $rows->banner_id; ?>"></a><?php } else if($rows->status ==0){ ?><a class="unpublish_img" rel="" id="" href="<?php echo site_url($this->uri->segment(1,0).'/'.$this->uri->segment(2,0).'/status_banner/'.$access_slug); ?>/<?php echo $rows->banner_id; ?>"></a><?php } ?></td>
                    <td class="center">
                        <a rel="<?php echo site_url($this->uri->segment(1,0).'/'.$this->uri->segment(2,0).'/delete_banner/'.$access_slug); ?>/<?php echo $rows->banner_id; ?>" class="delete_img" href="javascript:void(0)"></a>
                    </td>
                </tr>
    ...
    <fieldset class="sheet">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="file" id="logo_name" name="logo_name" class="input-file" > <a href="<?php echo site_url($this->uri->segment(1,0).'/'.$this->uri->segment(2,0).'/status_logo/'.$access_slug)?>" style="margin-right: 250px; float: right;" class="changeLogoStatus btn btn-info"><i class="icon-edit icon-white"></i></a><a href="javascript:void(0)" rel="<?php echo site_url($this->uri->segment(1,0).'/'.$this->uri->segment(2,0).'/delete_logo/'.$access_slug)?>" style="margin-right: 10px; float: right;" class="btn btn-danger"><i class="icon-trash icon-white"></i></a>
            </div>
        </div>

...
<div class="left-area">
  ...
  <form class="form-horizontal" name="form" id="formID4" action="<?php echo site_url($this->uri->segment(1,0).'/'.$this->uri->segment(2,0).'/'.$action.'/'.$this->uri->segment(4,NULL).'/'.$this->uri->segment(5,NULL))?>" method="post" enctype="multipart/form-data">
...
<?php } ?>
        ...
        <div class="control-group">
          ...
          <div class="controls">
          <textarea name="details" id="details" rows="" cols="" class="input-textarea-large"><?php echo isset($queryup[0]->details) ? $queryup[0]->details : set_value('details'); ?></textarea>
          </div>
        </div>
        <div class="control-group">

...
<head>
    ...
    <link rel="stylesheet" media="all" type="text/css" href="<?php echo base_url()?>assets/styles/jquery-ui.css" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>/assets/styles/jquery-ui-timepicker-addon.css" />
    ...
    <div class="body-wrapper">
        <div class="wrapper">
            ...
            <ul class="breadnav">
                ...
                <li><a class="<?php if($controller =='shops'){ echo 'active'; } ?>" href="<?php echo site_url('shops');?>"><?php echo $this->lang->line('shops'); ?></a></li>
                ...
                <li><a class="<?php if($controller =='advertisment'){ echo 'active'; } ?>" href="<?php echo site_url('sites');?>"><?php echo $this->lang->line('sites'); ?></a></li>

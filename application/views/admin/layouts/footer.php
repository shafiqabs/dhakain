...
<script type="text/javascript" src="<?php echo base_url() ?>assets/multiselect/js/jquery.multiselect.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/multiselect/js/jquery.multiselect.filter.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/media/examples_support/themes/ui-lightness/jquery-ui-1.8.4.custom.css" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/multiselect/css/jquery.multiselect.css" />
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/multiselect/css/jquery.multiselect.filter.css" />
...
<script type="text/javascript" src="<?php echo base_url()?>assets/js/ui/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/js/ui/jquery-ui-sliderAccess.js"></script>

<script type="text/javascript">

    jQuery(document).ready(function(){
        jQuery("#formID").validationEngine();
        jQuery("#storeID").validationEngine();
...
jQuery(document).ready(function(){
  $('#shop_name').change(function(){
            var shop_name = $("#formID4 input[name=shop_name]").val();
            var location_id = $("#formID4 select[name=location_id]").val();
            var shop_group = $("#formID4 select[name=shop_group]").val();
            $.ajax({
                type: "POST",
                url:"<?php echo site_url('store/ajax_check_store_name')?>",
                data:'shop_name='+shop_name+"&location_id="+location_id+"&shop_group="+shop_group,
                cache: false,
                beforeSend:function(){

...
if ( ! function_exists('paginate')){
    ...
    if($lastpage > 1)
    {
        ...
        // Previous
        if ($page > 1){
            $paginate.= "<li><a class='arrowPrev' href='$targetpage/$prev'>Prev</a></li>";
        }else{
           // $paginate.= "<li class='prev disabled' ><a href='#'>Prev</a></li>";
        }
        ...
        if ($lastpage < 7 + ($stages * 2))	// Not enough pages to breaking it up
        {
            ...
            {
                if ($counter == $page){
                    $paginate.= "<li><a  class='active' href='#'>$counter</a></li>";
                }else{
